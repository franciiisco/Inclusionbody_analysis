...
class InfoTab:
    ...
    def setup_info_tab(self):
        ...
        description = (
            ...
            "     2. Filtros: No utilizar filtros de contraste, tomar foto en campo claro.\n"
            "     3. Diafragma: El diafragma del condensador del microscopio debe estar cerrado al 50%.\n"
            "        Si el diafragma está abierto al 100%, las inclusiones de polifosfato no se verán correctamente.\n"
            "     4. Densidad celular: La cantidad de células por campo debe ser de mayor de 100.\n" \
            ...
            "     5. Iluminación: La iluminación debe ser ni muy brillante, ni muy oscura. El programa implementa varios algoritmos que normalizan la iluminación de las imágenes para mejorar la segmentación, aunque siempre son buenas practicas el intentar mantener una iluminación uniforme entre imagenes.\n"
            ...
            "     6. Fijación: La fijación de las células al portaobjetos se realiza mediante el tradicional metodo de frotis a la llama.\n"
            ...
            "     7. Toma de imágenes: Las imágenes deben tomarse con un microscopio óptico con un objetivo de 1000x de aumento. Es importante que las imagenes sean en blanco y negro (no en color), ya que el algoritmo está diseñado para trabajar con imágenes en escala de grises.\n\n"
            "     8. Tinción: La observacion de polifosfatos se realiza mediante tincion de NEISSER.\n\n"
