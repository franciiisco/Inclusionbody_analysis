...
class InfoTab:
    ...
    def setup_info_tab(self):
        ...
        description = (
            ...
            "     4. Iluminación: La iluminación debe ser ni muy brillante, ni muy oscura. El programa implementa varios algoritmos que normalizan la iluminación de las imágenes para mejorar la segmentación, aunque siempre son buenas practicas el intentar mantener una iluminación uniforme entre imagenes.\n"
            ...
            "     5. Fijación: La fijación de las células al portaobjetos se realiza mediante el tradicional metodo de frotis a la llama.\n"
            ...
            "     6. Toma de imágenes: Las imágenes deben tomarse con un microscopio óptico con un objetivo de 1000x de aumento. Es importante que las imagenes sean en blanco y negro (no en color), ya que el algoritmo está diseñado para trabajar con imágenes en escala de grises.\n\n"
            "     7. Tinción: La observacion de polifosfatos se realiza mediante tincion de NEISSER.\n\n"
